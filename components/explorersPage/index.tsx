      ...
      <section className={styles.hero} id="form">
        <div className={styles.heroLeft}>
          ...
          <p className={styles.body}>
            ...
            neighborhood, city, or country is really like before your next trip,
            stay, or move. Join the waitlist and be first in when we launch.
          </p>
          ...
          <div className={styles.testimonialCard}>
            ...
            <div>
              ...
              <p className={styles.testimonialQuote}>
                Gorgeous block by day, but the bar strip two streets over runs
                until 3am
              </p>
            </div>
          </div>
